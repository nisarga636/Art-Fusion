    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 h-screen w-full">
      ...
      <div className="bg-white  justify-center">
        <form className=" w-full h-screen bg-white p-8 px-8">
          <h1 className=" text-3xl mt-1     dark:text-black font-bold text-center">
            Art Fusion
          </h1>
          ...
          <center>
            <button className="w-52 mt-20 py-2 bg-blue-700 shadow-lg shadow-blue-700 hover:shadow-gray-500 hover:border-2 border-gray-700   hover:bg-gray-50  hover:text-blue-700 text-white font-semibold rounded-lg">
          ...
          <center>
            ...
            <h3 className="text-3sm  mt-28 dark:text-black font-semibold text-center">
              {" "}
