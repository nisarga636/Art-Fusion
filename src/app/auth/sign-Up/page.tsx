...
import ProductionOwner from './productionOwner/page';
    ...
    <div className='grid grid-cols-1 sm:grid-cols-2 h-screen w-full'>
      ...
      <div className='bg-white  justify-center'>
        ...
        <h1 className=' text-3xl mt-1     dark:text-black font-bold text-center'>Art Fusion</h1>
          <h2 className='text-xl  mt-7 dark:text-black font-semibold text-center'>Sign Up</h2>
        
          <div className='text-sm  p-28 flex flex-col text-black py-4 '>
            <label>Full Name</label>
            <input /*</div><AiOutlineEyeInvisible className=" mr-2 text-xl" />*/
              className=' p-2.5 rounded-lg bg-gray-300 mt-2'
              type="text" placeholder='enter your full name' required></input> 
          ...
          <div className='text-sm  p-28 flex flex-col text-black py-1'>
            ...
            <input /*</div><AiOutlineEyeInvisible className=" mr-2 text-xl" />*/
              className=' p-2.5 rounded-lg bg-gray-300 mt-2'
              type="text" placeholder='phone number' required></input> 
          ...
          <center><button className='w-52 mt-20 py-2 bg-blue-700 shadow-lg shadow-blue-700 hover:shadow-gray-500 hover:border-2 border-gray-700   hover:bg-gray-50  hover:text-blue-700 text-white font-semibold rounded-lg'>
          <a href="/auth/sign-In" className="underline"></a>
