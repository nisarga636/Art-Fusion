...
export default function Page() {
  return (
    <div>
      <Navbar />
      <main>
        <div className=" sticky bg-gray-400 text-black h-[600px] pl-10 py-64 ">
          <div className="text-3xl w-[442px]">
            Empowering Filmmakers, Connecting Dreams!
          </div>
          <div className="py-4 rounded-sm flex text-3xl space-x-4 cursor-pointer items-center">
